<?
function insert_Data($LPID, $LID, $TextBook, $HowToScore, $Goal, $Plan1, $Plan2, $Plan3, $Plan4, $Plan5, $Plan6, $Plan7, $Plan8, $Plan9, $Plan10, $Plan11, $Plan12, $Plan13, $Plan14, $Plan15){
	...
	$qeury1 = "update Lecture set LPID=$LPID where LID=$LID";
...
if(empty($_POST['made'])){
	...
	if($error !=""){
		...
		insert_Data($LPID, $LID, $TextBook, $HowToScore, $Goal, $Plan1, $Plan2, $Plan3, $Plan4, $Plan5, $Plan6, $Plan7, $Plan8, $Plan9, $Plan10, $Plan11, $Plan12, $Plan13, $Plan14, $Plan15);
		
}
else insert_Data($_POST['LPID'], $_POST['LID'], $_POST['TextBook'], $_POST['HowToScore'], $_POST['Goal'], $_POST['Plan1'], $_POST['Plan2'], $_POST['Plan3'], $_POST['Plan4'], $_POST['Plan5'], $_POST['Plan6'], $_POST['Plan7'], $_POST['Plan8'], $_POST['Plan9'], $_POST['Plan10'], $_POST['Plan11'], $_POST['Plan12'], $_POST['Plan13'], $_POST['Plan14'], $_POST['Plan15']);
?>
